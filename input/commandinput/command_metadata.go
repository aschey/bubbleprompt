...
// CommandMetadataAccessor defines the interface that the [Model] uses to get information about the supplied [suggestion.Suggestion].
...
// CommandMetadata defines the metadata that the [Model] uses to get information about the supplied [suggestion.Suggestion].
...
// GetShowFlagPlaceholder returns whether or not to show the placeholder indicating this [suggestion.Suggestion] has available flags.
