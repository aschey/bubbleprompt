...
## type [Input](<https://github.com/aschey/bubbleprompt/blob/main/input/input.go#L16-L44>)
...
## type [RoundingBehavior](<https://github.com/aschey/bubbleprompt/blob/main/input/token.go#L48>)
...
### func [FindCurrentToken](<https://github.com/aschey/bubbleprompt/blob/main/input/token.go#L55>)
...
### func [NewViewBuilder](<https://github.com/aschey/bubbleprompt/blob/main/input/viewbuilder.go#L20>)

```go
func NewViewBuilder(cursor int, cursorStyle lipgloss.Style, delimiter string, showCursor bool) *ViewBuilder
```

### func \(ViewBuilder\) [Last](<https://github.com/aschey/bubbleprompt/blob/main/input/viewbuilder.go#L60>)

```go
func (v ViewBuilder) Last() *byte
```

### func \(\*ViewBuilder\) [Render](<https://github.com/aschey/bubbleprompt/blob/main/input/viewbuilder.go#L31>)

```go
func (v *ViewBuilder) Render(newRunes []rune, column int, style lipgloss.Style)
```

### func \(\*ViewBuilder\) [RenderPlaceholder](<https://github.com/aschey/bubbleprompt/blob/main/input/viewbuilder.go#L54>)

```go
func (v *ViewBuilder) RenderPlaceholder(newRunes []rune, offset int, style lipgloss.Style)
```

### func \(ViewBuilder\) [View](<https://github.com/aschey/bubbleprompt/blob/main/input/viewbuilder.go#L24>)

```go
func (v ViewBuilder) View() string
```

### func \(\*ViewBuilder\) [ViewLen](<https://github.com/aschey/bubbleprompt/blob/main/input/viewbuilder.go#L50>)
