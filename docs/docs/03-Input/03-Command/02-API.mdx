...
- [type CommandMetadata](<#type-commandmetadata>)
  ...
  - [func \(m CommandMetadata\) GetFlagPlaceholder\(\) FlagPlaceholder](<#func-commandmetadata-getflagplaceholder>)
...
- [type FlagPlaceholder](<#type-flagplaceholder>)
  - [func \(p FlagPlaceholder\) Text\(\) string](<#func-flagplaceholder-text>)
...
## type [CommandMetadata](<https://github.com/aschey/bubbleprompt/blob/main/input/commandinput/command_metadata.go#L12-L18>)
...
### func [MetadataFromPositionalArgs](<https://github.com/aschey/bubbleprompt/blob/main/input/commandinput/command_metadata.go#L20>)
...
### func \(CommandMetadata\) [GetFlagPlaceholder](<https://github.com/aschey/bubbleprompt/blob/main/input/commandinput/command_metadata.go#L30>)

```go
func (m CommandMetadata) GetFlagPlaceholder() FlagPlaceholder
```

### func \(CommandMetadata\) [GetLevel](<https://github.com/aschey/bubbleprompt/blob/main/input/commandinput/command_metadata.go#L38>)

```go
func (m CommandMetadata) GetLevel() int
```

### func \(CommandMetadata\) [GetPositionalArgs](<https://github.com/aschey/bubbleprompt/blob/main/input/commandinput/command_metadata.go#L26>)

```go
func (m CommandMetadata) GetPositionalArgs() []PositionalArg
```

### func \(CommandMetadata\) [GetPreservePlaceholder](<https://github.com/aschey/bubbleprompt/blob/main/input/commandinput/command_metadata.go#L42>)

```go
func (m CommandMetadata) GetPreservePlaceholder() bool
```

### func \(CommandMetadata\) [GetShowFlagPlaceholder](<https://github.com/aschey/bubbleprompt/blob/main/input/commandinput/command_metadata.go#L34>)

```go
func (m CommandMetadata) GetShowFlagPlaceholder() bool
```

## type [CommandMetadataAccessor](<https://github.com/aschey/bubbleprompt/blob/main/input/commandinput/command_metadata.go#L4-L10>)

CommandMetadataAccessor defines the interface that the [Model](/input/commandinput/api#type-model) uses to get information about the supplied list of [suggestion.Suggestion](/suggestion/api#type-suggestion).
...
### func \(FlagPlaceholder\) [Text](<https://github.com/aschey/bubbleprompt/blob/main/input/commandinput/model.go#L44>)
