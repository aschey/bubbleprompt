...
## func [Complete](<https://github.com/aschey/bubbleprompt/blob/main/suggestion/commands.go#L42>)
...
## type [SuggestionMsg](<https://github.com/aschey/bubbleprompt/blob/main/suggestion/commands.go#L37-L40>)
